<template>
  <div class="lan" v-if="nowTime >= new Date('2024 1-20').getTime() && nowTime <= new Date('2024 2-21').getTime()">
    <div class="lan-header">
      <div class="container">🎆 2024 <HtmlLink href="https://en.wikipedia.org/wiki/Chinese_New_Year" text="New Year"></HtmlLink> 🎆</div>
    </div>
    <div class="lan-box">
